...
--
-- Hôte : localhost
-- Généré le : mar. 08 juil. 2025 à 19:14
...
CREATE TABLE `ETUDIANT` (
  `id_etudiant` varchar(10) NOT NULL,
  `nom_etudiant` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `nie_etudiant` varchar(20) DEFAULT NULL,
  `prenom_etudiant` varchar(20) DEFAULT NULL,
  `filiere_etudiant` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
ALTER TABLE `ETUDIANT`
  ...
  ADD UNIQUE KEY `nie_etudiant` (`nie_etudiant`),
