<?php // This file is intentionally left mostly as HTML. ?>
<!DOCTYPE html>
<html lang="fr">
<head>
  <meta charset="UTF-8">
  ...
  * {
  ...
  /* Hero  */
  .hero {
    /* fond violet et sary na club iray*/
    background: linear-gradient(rgba(13, 1, 83, 0.8), rgba(143, 16, 143, 0.8)), 
                url('./img/basket.webp') center/cover;
    color: white;
    text-align: center;
    padding: 80px 20px;
  }
  ...
  <section id="clubs" class="clubs-container">
    ...
    <div class="carousel-container">
      ...
      <div class="club-cards">
        ...
        <!-- Club Basket -->
        <div class="club-card">
          <div class="club-image" style="background-image: url('img/basket.webp'); background-color: #f5f5f5;"></div>
          <div class="club-info">
            <h3>Club Basket</h3>
        ...
        <!-- Club Foot -->
        <div class="club-card">
          <div class="club-image" style="background-image: url('./img/foot.webp'); background-color: #f5f5f5;"></div>
          <div class="club-info">
            <h3>Club Football</h3>
        ...
        <!-- Club Danse -->
        <div class="club-card">
          <div class="club-image" style="background-image: url('./img/danse.webp'); background-color: #f5f5f5;"></div>
          <div class="club-info">
            <h3>Club Danse</h3>
        ...
        <!-- Club Théâtre -->
        <div class="club-card">
          <div class="club-image" style="background-image: url('./img/theatre.webp'); background-color: #f5f5f5;"></div>
          <div class="club-info">
            <h3>Club Théâtre</h3>
        ...
        <!-- Club Musique -->
        <div class="club-card">
          <div class="club-image" style="background-image: url('./img/club_musique.webp'); background-color: #f5f5f5;"></div>
          <div class="club-info">
            <h3>Club Musique</h3>
