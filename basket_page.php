...
<body>
  ...
  <div class="info">
    <h1 class="bienvenue">Bienvenue au club de basket de l'ESMIA</h1>
   <p>Vous êtes passionné de basket ou simplement curieux de découvrir ce sport collectif dynamique et formateur ?</p>
    <p>Le Club de Basket de l'ESMIA vous ouvre ses portes, que vous soyez débutant, confirmé ou compétiteur !</p>
    <h1 class="rejoindre">Pourquoi nous rejoindre ?</h1>
    <p>🏆 Entraînements réguliers et compétitions encadrées </p>
    <p>👟 Initiation pour les débutants, perfectionnement pour les plus avancés </p>
    <p>👨‍👩‍👧‍👦 Ambiance familiale et esprit d’équipe </p>
    <p>📍 Infrastructures modernes et accessibles </p>
    <p>🎉 Événements tout au long de l’année (tournois, stages, sorties) </p>
  </div>
  <script>
    function openForm() {
